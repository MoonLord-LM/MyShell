...
# MySQL 8.0.12 在线安装
# sudo chmod -R 777 ./ && sudo sh ./mysql_8.0.12.sh --install
# sudo chmod -R 777 ./ && sudo sh ./mysql_8.0.12.sh --reinstall
# sudo chmod -R 777 ./ && sudo sh ./mysql_8.0.12.sh --clean_cache
